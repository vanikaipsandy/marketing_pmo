            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#171717]">
                <div class="mb-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <h1 class="text-xl font-bold text-slate-900 dark:text-white">Add Roadmap</h1>
                        <p class="text-sm text-slate-500 dark:text-slate-400">
                            Pilih initiative untuk menambahkan activity roadmap.
                        </p>
                    </div>
                ...
                <div class="max-w-sm">
                    ...
                    >
                        <option :value="null">-- Pilih Initiative --</option>
            ...
            >
                <p class="text-sm font-medium text-slate-600 dark:text-slate-300">
                    <template v-if="projects.length">
                        Pilih initiative di atas untuk mulai tambah activity roadmap.
                    </template>
                    <template v-else>
                        Belum ada initiative dengan data durasi / milestone bertanggal untuk diproses.
                    </template>
                </p>
            </section>
        </div>
